...
function TooltipArrow({ className, variant, ...props }: TooltipArrowProps) {
	return (
		<TooltipPrimitive.Arrow
			...
			className={cn(
				"z-50 data-[side=bottom]:-top-2 data-[side=left]:right-[-13px] data-[side=left]:rotate-90 data-[side=right]:left-[-13px] data-[side=right]:-rotate-90 data-[side=top]:bottom-[-8px] data-[side=top]:rotate-180",
				className,
			)}
			{...props}
		>
